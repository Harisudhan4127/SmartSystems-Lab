...
# model.predict(source="background-10.mp4", save=True, imgsz=320, conf=0.5)
# # Configure the tracking parameters and run the tracker
# model = YOLO('yolov8n.pt')

# results = model.track(source="background-10.mp4",conf=0.3, iou=0.5, save=True, tracker="bytetrack.yaml")

# Load the YOLOv8 model
model = YOLO('yolov8n.pt')

# Set up video capture
cap = cv2.VideoCapture("background-10.mp4")
...
video_info = sv.VideoInfo.from_video_path("background-10.mp4")
