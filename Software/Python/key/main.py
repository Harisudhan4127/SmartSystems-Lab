...
file_dir = r"D:\VS_Code\python\key\willam"
items = os.listdir(file_dir)
text_file= '2023-09-17' 
# print(items)
# print(main())

if main(text_file):
    print("It is not possible to run this script")
else :
    print("It is possible to run this script")
